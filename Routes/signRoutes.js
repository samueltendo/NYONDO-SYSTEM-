...
// GET: View Receipt by ID
// router.get('/receipt/:id', async (req, res) => {
//     try {
//         // Fetch sale and populate the salesAttendant/product if needed
...
//             sale: sale,
//             // Format receipt number: NYO-2024-ID
//             receiptNo: `NYO-${new Date().getFullYear()}-${sale._id.toString().slice(-6).toUpperCase()}`
//         });
//     } catch (err) {
